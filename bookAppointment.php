    ...
    <form method="POST" action="processingAppointment.php">
        ...
        <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <textarea rows="5" cols="50" class="form-control" name="initial_complaint" placeholder="Enter a short description of your complaint"> Enter a short description of your complaint</textarea>
            </div>
